...
[В видео](https://www.youtube.com/watch?v=TroMaXGrYXM&t=308s) демонстриуется работа интерфейса дисплея. Одновременно с этим можно видеть две основные проблемы:
