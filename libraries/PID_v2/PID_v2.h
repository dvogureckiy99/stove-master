...
#define P_ON_E 1
	...
	PID(unsigned int*, int*, unsigned int*,        // * constructor.  links the PID to the Input, Output, and 
		double, double,  byte, byte);//   Setpoint.  Initial tuning parameters are also set here.
										  //   (overload for specifying proportional mode)

	PID(unsigned int*, int*, unsigned int*,        // * constructor.  links the PID to the Input, Output, and 
		double, double,  byte);     //   Setpoint.  Initial tuning parameters are also set here
	...
	void SetSampleTime(byte);              // * sets the frequency, in Milliseconds, with which 
